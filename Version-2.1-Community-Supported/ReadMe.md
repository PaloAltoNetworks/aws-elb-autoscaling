...
* More detailed set of deployment steps are available here (coming soon). Complete documentation, similar to earlier versions, will be available when version 2.1-CS is released.
